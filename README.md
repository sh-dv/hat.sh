...
[hat.sh](https://hat.sh) is a  javascript app that provides secure file encryption using the [AES-GCM 256](https://www.w3.org/TR/WebCryptoAPI/#aes-gcm) algorithm from [WebCryptoAPI](https://www.w3.org/TR/WebCryptoAPI/#aes-gcm) provided by your browser.
